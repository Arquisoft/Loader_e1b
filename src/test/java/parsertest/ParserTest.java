...
public class ParserTest {
	...
	public void testLoadExcelExito() throws FileNotFoundException, DocumentException {
		RList ex = new RList();
		ex.load("src/test/resources/Prueba.xlsx");
		...
		assertEquals(st.toString(), "Juan Torres Pardo C/ Federico García Lorca 2 90500084Y 1.0 ");
		...
		assertEquals(st.toString(), "Luis López Fernando C/ Real Oviedo 2 19160962F 1.0 ");
		...
		assertEquals(st.toString(), "Ana Torres Pardo Av. De la Constitución 8 09940449X 1.0 ");
	}
